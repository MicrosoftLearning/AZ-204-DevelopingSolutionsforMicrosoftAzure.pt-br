...
1. Na guia **Avançado**, na lista suspensa **Esquema de Evento**, selecione **Esquema de Grade de Eventos** e, então, selecione **Revisar + criar**.
...
1. Adicione o seguinte código e substitua **\<topic-endpoint\>** e **\<topic-key\>** pelos valores que você registrou na etapa anterior:

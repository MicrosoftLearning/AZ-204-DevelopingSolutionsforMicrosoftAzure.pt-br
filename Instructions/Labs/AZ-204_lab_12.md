...
1. Na folha **Criar uma conta** de armazenamento, na guia **Noções básicas**, realize as ações a seguir.
...
1. Na guia **Avançado**, verifique se a opção **Permitir habilitar o acesso público em contêineres individuais** está habilitada. Marque a caixa se não estiver habilitada.
...
1. Na folha **Visão geral do Serviço de Aplicativo**, em **Essentials**, registre o valor do link da **URL**. Você usará esse valor mais adiante no laboratório.

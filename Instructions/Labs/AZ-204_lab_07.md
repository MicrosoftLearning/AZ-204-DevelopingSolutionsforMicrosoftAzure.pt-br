...
1. Na folha **Criar cofre de chaves**, na guia **Informações básicas**, realize as seguintes ações e selecione a guia **Configuração de Acesso**:
...
1. Na guia **Configuração de Acesso**, altere o modelo de permissão para **Política de acesso ao cofre**.

1. Selecione a guia **Revisar + criar** e revise as opções selecionadas durante as etapas anteriores.
...
1. Substitua o conteúdo do código gerado automaticamente da função **FileParser** começando pela linha 19 com o seguinte código:

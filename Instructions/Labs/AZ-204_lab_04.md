...
Por fim, você definirá o nível de consistência de sua instância do Cosmos DB e implementará uma função do Azure para notificações de feed de alterações.
...
1. Na folha **Selecionar opção de API**, selecione **Criar** na caixa **Azure Cosmos DB for NoSQL**.

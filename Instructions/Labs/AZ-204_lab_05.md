...
1. Alterne para o aplicativo **Terminal do Windows**.
...
1. Na caixa de diálogo **Abrir**, navegue até o diretório **Allfiles (F):\\Allfiles\\Labs\\05\\Starter\\diretório func** vazio, selecione **lab05.zip**e selecione **Abrir**.

    > **Observação**: Isso fará o upload do arquivo para o **/~** diretório dentro da sessão do **Cloud Shell**.

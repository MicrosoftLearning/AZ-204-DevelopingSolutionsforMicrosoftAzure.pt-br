...
Encontre a barra de tarefas na área de trabalho do Windows 10. A barra de tarefas contém os ícones dos aplicativos que você usará neste laboratório:
...
1. Na folha **Criar aplicativo Web**, na guia **Básico**, realize as ações a seguir:
    ...
    | Seção **Plano de preços** | Selecione **Explorar planos de preço** na página **Selecionar plano de preços de Serviço de Aplicativo**, selecione **S1** e, então, selecione **Selecionar** |

1. Selecione **Avançar: Docker >**.
...
1. Na folha **Instalar gateway do Gerenciamento de API**, realize as seguintes ações e selecione **Revisar + criar**:
...
1. Na seção **Resposta HTTP**, realize as seguintes ações:
    ...
    1. Se o pop-up de confirmação de habilitação de rastreamento for aberto, selecione o botão **Habilitar rastreamento por uma hora** 

    1. Examine o conteúdo nas caixas de texto **Back-end** e **Saída** e observe que elas incluem detalhes das operações de API correspondentes com suas informações de tempo.
